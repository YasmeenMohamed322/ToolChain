...
void TIM1_TRG_COM_IRQHandl(void) __attribute__((weak,alias("Default_Handler")));
...
void TIM8_TRG_COM_IRQHandl           (void) __attribute__((weak,alias("Default_Handler")));
...
uint32_t Vectors[] __attribute__((section(".isr_vector"))) =
{
    ...
    (uint32_t)TIM1_TRG_COM_IRQHandl,
    ...
    (uint32_t)TIM8_TRG_COM_IRQHandl,
